            ...
            >
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    onClick={toggleIcons}
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-red-600 hover:bg-red-700 shadow-sm transition-all duration-300 ml-11 mr-1 hover:scale-105 active:scale-95"
                    aria-label="Close icons"
                    size="icon"
                  >
                    <X className="size-6 text-white" />
